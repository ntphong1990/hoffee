    ...
    public function admin_index()
    {
        ...
        $this->Paginator->settings = array(
            'Stock' => array(
                ...
                'fields' => 'Stock.id, product_id, store_id, type_id, SUM(quantity) as total,Stock.note,Product.name',
                'group' => ['product_id']
            )
        );
 ...
 */
    public function admin_add()
    {
        ...
        $stores = $this->Stock->Store->find('list');
        $this->set(compact('stores'));
                
        $types = $this->Stock->Stocktype->find('list');
