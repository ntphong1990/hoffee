 ...
 */
    public function admin_add()
    {
        ...
        $this->loadModel('Ward');
        $locations = $this->District->find('all', array('fields' => array('id', 'name'),'order' => array('name' => 'ASC')));
        $this->set('district', $locations);




        $states =  $this->Ward->find('all', array('fields' => array('id', 'name','provinceid'),'conditions' => array()));
